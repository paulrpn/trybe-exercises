...
SELECT Provider, Price FROM Provides ORDER BY Price DESC LIMIT 40 OFFSET 2;
...
SELECT COUNT(*) AS 'Qtde de empresas que fornecem a peça 1' FROM Provides WHERE Piece = 1;
